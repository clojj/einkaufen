			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_1: {
							ctor: '::',
							_0: _zwilias$elm_touch_events$Touch$onStart(_user$project$Main$Swipe),
							_1: {
								ctor: '::',
								_0: _zwilias$elm_touch_events$Touch$onEnd(_user$project$Main$SwipeEnd),
								_1: {ctor: '[]'}
							}
						}
					},
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$id('abcColumn'),
							_1: {
								ctor: '::',
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _zwilias$elm_touch_events$Touch$onMove(_user$project$Main$Swipe),
										_1: {
											ctor: '::',
											_0: _zwilias$elm_touch_events$Touch$onEnd(_user$project$Main$SwipeEnd),
											_1: {ctor: '[]'}
									...
									},
									{
										...
										_0: _elm_lang$html$Html$text(
											_elm_lang$core$String$toUpper(
												_elm_lang$core$String$fromChar(ch))),
										_1: {ctor: '[]'}
									});
							},
							_user$project$Main$abc)),
					_1: {ctor: '[]'}
				}
			}
		});
