...
var _zwilias$elm_touch_events$Touch$onEndWithOptions = F2(
...
var _zwilias$elm_touch_events$Touch$onEnd = _zwilias$elm_touch_events$Touch$onEndWithOptions(
...
var _user$project$Main$menu = function () {
	var menuElementStyle = _elm_lang$html$Html_Attributes$style(
		{
			ctor: '::',
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: A2(_user$project$Main$link, 'list', '#/list'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: A2(_user$project$Main$link, 'admin', '#/admin'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Main$abcLetters = _elm_lang$core$String$toList('ABCDEFGHIJKLMNOPQRSTUVWXYZ');
var _user$project$Main$tspanLetters = function (dx) {
	return A2(
		_elm_lang$core$List$map,
		function (ch) {
			...
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$x(dx),
					_1: {
						ctor: '::',
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$id('svgABC'),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$class('abc'),
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$viewBox('0 0 30 530'),
											_1: {ctor: '[]'}
										}
									}
								},
								{
									...
									_0: A2(
												...
												_1: {
													...
													_1: {
														...
														_1: {
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$svg$Svg_Attributes$pointerEvents('all'),
																_1: {ctor: '[]'}
															}
														}
													}
										...
										_user$project$Main$tspanLetters('0')),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$svg$Svg$text_,
											...
											_user$project$Main$tspanLetters('10')),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$svg$Svg$text_,
												...
												_user$project$Main$tspanLetters('20')),
											_1: {ctor: '[]'}
										}
									}
								}),
...
var _user$project$Main$subscriptions = function (_p1) {
	return _user$project$Main$input(_user$project$Main$AbcTouched);
};
var _user$project$Main$SwipeEnd = function (a) {
	return {ctor: 'SwipeEnd', _0: a};
};
var _user$project$Main$Swipe = F2(
	function (a, b) {
		return {ctor: 'Swipe', _0: a, _1: b};
	});
var _user$project$Main$NoOp = {ctor: 'NoOp'};
var _user$project$Main$SwipeUp = {ctor: 'SwipeUp'};
var _user$project$Main$SwipeDown = {ctor: 'SwipeDown'};
var _user$project$Main$SwipeLeft = {ctor: 'SwipeLeft'};
var _user$project$Main$SwipeRight = {ctor: 'SwipeRight'};
var _user$project$Main$Tap = {ctor: 'Tap'};
var _user$project$Main$gestureType = function (gesture) {
	return _zwilias$elm_touch_events$Touch$isTap(gesture) ? _elm_lang$core$Maybe$Just(_user$project$Main$Tap) : (A2(_zwilias$elm_touch_events$Touch$isLeftSwipe, _user$project$Main$swipeSensitivity, gesture) ? _elm_lang$core$Maybe$Just(_user$project$Main$SwipeLeft) : (A2(_zwilias$elm_touch_events$Touch$isRightSwipe, _user$project$Main$swipeSensitivity, gesture) ? _elm_lang$core$Maybe$Just(_user$project$Main$SwipeRight) : (A2(_zwilias$elm_touch_events$Touch$isDownSwipe, _user$project$Main$swipeSensitivity, gesture) ? _elm_lang$core$Maybe$Just(_user$project$Main$SwipeDown) : (A2(_zwilias$elm_touch_events$Touch$isUpSwipe, _user$project$Main$swipeSensitivity, gesture) ? _elm_lang$core$Maybe$Just(_user$project$Main$SwipeUp) : _elm_lang$core$Maybe$Nothing))));
};
			...
			case 'Swipe':
				...
				var newY = A2(
					...
					function (_) {
						...
						_zwilias$elm_touch_events$Touch$locate(_p3)));
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{gesture: newGesture, posY: newY}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				var newGesture = A2(_zwilias$elm_touch_events$Touch$record, _p2._0, model.gesture);
				var tt = A2(
					_elm_lang$core$Debug$log,
					'touch-type: ',
					_user$project$Main$gestureType(newGesture));
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{gesture: newGesture, touchType: tt}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$Main$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$Main$init, view: _user$project$Main$view, update: _user$project$Main$update, subscriptions: _user$project$Main$subscriptions})(_elm_lang$core$Json_Decode$bool);
